...
// Source: index-7 / Section11 (Get in touch). Content: Sorta Famous — CTA.
                ...
                <div className="row align-items-start g-4 g-xl-5">
                    <div className="col-xl-5 col-lg-6 col-12">
                        <div className="sec-11-home-7__eyebrow d-inline-flex align-items-center gap-2 mb-4 text-uppercase">
                            <span className="text-scramble" data-scramble-text="Get Started">Get Started</span>
                            {EYEBROW_ARROW_SVG}
                        </div>
                        <h2 className="sec-11-home-7__title mb-0 reveal-text"><RevealText>Let&apos;s get Sorta Famous</RevealText></h2>
                    </div>
